...
export default function PriceListCard({
  ...
  return (
    <div
      ...
      style={{
        // Fans out symmetrically from the active card, peeking out on
        // both sides -- matching the approved reference image. Swiping
        // cycles the active card around (wrappedOffset in the parent
        // wraps past either end), so a card that recedes off one side
        // comes back around from the other, like flipping through a
        // deck.
